...
class AuthController extends Controller
{
    ...
    */
    ...
    public function logout()
    {
        ...
        // Chỗ này họ đang kiểm tra nếu là loại người dùng lad admin thì redirect về trang admin login
        // Còn ngược lại thì về trang user
        // Tuy nhiên anh sửa chỗ này thành kiểm tra đường dẫn nên nó bị sai, bởi vì logout thì chỉ có 1 đường dẫn
        if (request()->is('admin/*')) {
