...
Route::get('/home-page', 'HomeController@index')->name('home-page');
...
Route::get('mua-nhieu-hang/{id}/{quantity}',['as'=>'mua-nhieu-hang','uses'=>'HomeController@buyMultiple']);
Route::get('mua-hang/{id}/{ten}',['as'=>'muahang','uses'=>'HomeController@buyding']);

// Route::get('mua-hang',['as'=>'muahang','uses'=>'HomeController@buyding']);
//Route::get('mua-hang/{id}/{url}',['as'=>'buynow','uses'=>'HomeController@buyding']);
// Route::get('mua-hang/{id}/{url}', 'HomeController@buyding')->name('buynow');
Route::get('gio-hang',['as'=>'giohang','uses'=>'HomeController@cart']);
Route::get('xoa-san-pham-gio-hang/{id}',['as'=>'xoasanphamgiohang','uses'=>'HomeController@deleteItemInCart']);
...
Route::group(['prefix' => 'admin','middleware' => 'auth'], function() {
    // 'as'=>'admin.index' chính là tên của route
