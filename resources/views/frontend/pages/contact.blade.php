...
@section('content')
  ...
  <section id="aa-catg-head-banner">
   <img src="{!! url('public/images/contactpanel.jpg') !!}" alt="fashion img" style="width: 1920px; height: 450px;" >
             ...
             <div class="row">
               ...
               <div class="col-md-4">
                 <div class="aa-contact-address-right" style="font: tahoma, sans-serif;">
                   <address>
                     <h4 style="font:24px tahoma, sans-serif; color:red;"><b><i>Thực phẩm sạch</i></b></h4>
                     <p>Chất lượng là hàng đầu</p>
                     <p><span class="fa fa-home"></span>Thực phẩm sạch</p>
                     <p><span class="fa fa-phone"></span>0353-517-700</p>
                     <p><span class="fa fa-envelope"></span>Email: thucphamsach@gmail.com</p>
                   </address>
                 </div>
               </div>
             </div>
