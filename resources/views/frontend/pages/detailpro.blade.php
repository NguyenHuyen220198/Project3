...
@section('content')
  ...
  <section id="aa-catg-head-banner">
   <img src="{!! asset('resources/upload/sanpham/'.$sanpham->sanpham_anh) !!}" alt="fashion img" style="width: 1920px; height: 450px;">
        ...
        <div class="aa-product-details-content">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="aa-prod-view-bottom">
              <div>
                <input type="number" max="100" class="input_order_quantity" name="order_quantity" value="1" style="width: 100px;">
                <span class="message_order_quantity" style="color: #e40202"></span>
              </div>
              <button class="aa-add-to-cart-btn" homePage="{!! route('home-page') !!}" hrefUrl="{!! url('mua-nhieu-hang') !!}" data-id="{{$sanpham->id}}"><span class="fa fa-shopping-cart">Mua hàng</span></button>
            </div>
            </div>
          </div>
...
<script>
  $(document).ready(function(){
    ...
    $('input[name="order_quantity"]').change(function(){
      ...
      } else if (quantity > {{$sanpham->lohang_so_luong_hien_tai}}) {
    ...
    $('.aa-add-to-cart-btn').click(function(e){
      ...
      $.ajax({
        url: $(this).attr('hrefUrl')+ '/'+$(this).attr('data-id')+'/'+quantity,
        method: 'get',
        dataType: 'JSON',
      ...
      setTimeout(() => {
        location.href = $(this).attr('homePage');
        alert('Đã thêm vào giỏ hàng!');
      }, 500);
    });
  });
