...
@section('content')
  ...
  @if (!is_null($khuyenmai))
   <img src="{!! asset('resources/upload/khuyenmai/'.$khuyenmai->khuyenmai_anh) !!}" alt="fashion img" style="width: 1920px; height: 450px;" >
   @else
   <img src="{!! url('public/images/promotionpanel.jpg') !!}" alt="fashion img" style="width: 1920px; height: 450px;" >
   @endif
